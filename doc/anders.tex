...
In the topos where paths commute,
...
Higher paths, coherently bound,
define equivalence, symmetry found.
A contractible witness, a space of proof,
where judgment refines by computational truth.

Thus, in the category where cubes unfold,
types are spaces, and spaces hold—
not mere sets, but forms refined,
inhabiting proof in cubical mind.
